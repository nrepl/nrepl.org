...
NOTE: Despite the name of the repo, we're currently publishing the site to https://nrepl.xyz.

The site is generated from the asciidoc files in the link:https://github.com/nrepl/nREPL/tree/master/doc[doc] folder of nREPL's GitHub repo and is published to https://nrepl.xyz.
